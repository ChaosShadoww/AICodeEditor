...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    require(["vs/editor/editor.main"], function (ignorable) {
        ...
        layout.registerComponent("ai", function (container, state) {
            ...
            textBox.id = "ai-textbox";
            textBox.placeholder = "Ask the AI Assistant...";
            ...
            responseBox.id = "ai-response";
            responseBox.style.width = "100%";
            responseBox.style.height = "200px";
            responseBox.style.overflowY = "auto";
            responseBox.style.border = "1px solid #ddd";
